...
.. list-table::
    ...
    - - Performance
      - Native C, linear time (27x-89x faster on the corpus below)
...
within 100 bytes, and its C engine is 27x to 89x faster -- csscompressor's regex passes turn quadratic on a large

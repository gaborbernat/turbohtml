...
Markup serialization and :attr:`Node.text` walk trees iteratively and do not impose a nesting limit. The stateful
:meth:`Node.to_markdown`, :meth:`Node.to_text`, and :meth:`Node.to_annotated_text` formatters accept nesting below 1,024
levels. At 1,024 levels they raise :exc:`RecursionError` before allocating output or invoking a converter; they never

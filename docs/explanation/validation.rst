...
Compilation and validation first inspect tree depth iteratively. A schema or instance nested 400 levels or deeper raises
:class:`RecursionError` before a recursive grammar walk starts, including on small worker-thread stacks.

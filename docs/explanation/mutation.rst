...
Subtree copy, cross-tree adoption, equality, and :meth:`~turbohtml.Element.normalize` follow parent links iteratively.
Their result is complete at any nesting depth that fits in memory; none uses the HTML parser's construction limit as a
mutation limit.

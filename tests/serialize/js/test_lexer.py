...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("a<!--b\nc", "IDENT:a *IDENT:c EOF", id="html-open-comment"),
        pytest.param("a\n-->b\nc", "IDENT:a *IDENT:c EOF", id="html-close-comment"),
        pytest.param("a\n /**/ -->b\nc", "IDENT:a *IDENT:c EOF", id="html-close-after-block-comment"),
        pytest.param("a/*\n*/-->b\nc", "IDENT:a *IDENT:c EOF", id="html-close-after-multiline-comment"),
        pytest.param("a-->b", "IDENT:a DEC GT IDENT:b EOF", id="html-close-mid-line"),
        pytest.param("a\n--b", "IDENT:a *DEC IDENT:b EOF", id="line-leading-decrement"),
        pytest.param("a\n-bc", "IDENT:a *MINUS IDENT:bc EOF", id="line-leading-minus"),
        pytest.param("a<!-b", "IDENT:a LT NOT MINUS IDENT:b EOF", id="html-open-needs-two-dashes"),
        pytest.param("a<!", "IDENT:a LT NOT EOF", id="html-open-truncated"),
        pytest.param("a\n--", "IDENT:a *DEC EOF", id="html-close-truncated"),

...
from turbohtml._html import _linkify_find, _linkify_has
...
def test_has_rejects_non_str_text() -> None:
    with pytest.raises(TypeError):
        _linkify_has(123, True, True, (), ())  # ruff:ignore[boolean-positional-value-in-call]  # ty: ignore[invalid-argument-type]

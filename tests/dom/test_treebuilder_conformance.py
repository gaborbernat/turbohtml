...
# The pinned corpus predates foreign end-tag corrections and HTML processing
# instructions. These expectations follow the living WHATWG tree-construction rules.

...
_AttrValue: TypeAlias = str | list[str] | None

@final
class _Attrs(MutableMapping[str, _AttrValue]):
    __hash__: ClassVar[None]  # type: ignore[assignment]  # a mutable mapping is unhashable, as dict is
    def __getitem__(self, key: str, /) -> _AttrValue: ...
    def __setitem__(self, key: str, value: _AttrValue, /) -> None: ...
    def __delitem__(self, key: str, /) -> None: ...
    def __iter__(self) -> Iterator[str]: ...
    def __len__(self) -> int: ...
    def copy(self) -> dict[str, _AttrValue]: ...
    def __or__(self, other: Mapping[str, _AttrValue], /) -> dict[str, _AttrValue]: ...
    def __ror__(self, other: Mapping[str, _AttrValue], /) -> dict[str, _AttrValue]: ...
    def __ior__(self, other: Mapping[str, _AttrValue], /) -> Self: ...
...
class Node:
    @property
    def parent(self) -> Element | Document | DocumentFragment | None: ...
    @property
    ...
    @property
    def ancestors(self) -> Iterator[Element | Document | DocumentFragment]: ...
    @property
...
def _reconstruct(kind: int, descriptor: object, children: list[Node], xml: int = 0, /) -> Node: ...

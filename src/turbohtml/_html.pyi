...
class Node:
    ...
    def xpath(self, expression: str, /) -> list[Element | str]: ...
    def xpath_iter(self, expression: str, /) -> Iterator[Element | str]: ...
    def xpath_one(self, expression: str, /) -> Element | str | None: ...

...
class Node:
    ...
    # smart_strings (a bool, default False) is also accepted; it rides in via **variables.
    def xpath(self, expression: str, /, **variables: str | float | bool) -> list[Element | str]: ...
    def xpath_iter(self, expression: str, /, **variables: str | float | bool) -> Iterator[Element | str]: ...
    def xpath_one(self, expression: str, /, **variables: str | float | bool) -> Element | str | None: ...

...
typedef struct {
    ...
    PyObject *document_fragment_type; /* DocumentFragment (a parentless container of nodes) */
    PyObject *shadow_root_type;       /* ShadowRoot (the DocumentFragment rooting a shadow tree) */
